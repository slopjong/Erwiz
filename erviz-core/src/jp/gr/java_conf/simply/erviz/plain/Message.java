...
import jp.gr.java_conf.simply.erviz.common.MessageGenerator;
...
enum Message {
	...
	//constants
	private static final String RESOURCE_NAME = "jp.gr.java_conf.simply.erviz.plain.resources.messages";
